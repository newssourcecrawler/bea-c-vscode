# bea-c VS Code
VS Code extension for local bea-c evidence reports from exported logs and transcripts.
bea-c helps you open an exported evidence file, choose the matching reader, and generate a source-backed report inside VS Code.
## What bea-c reads
...
The VS Code extension package is MIT licensed.

The bea-c Rust core and CLI are separate and are not covered by this repository unless separately stated.
